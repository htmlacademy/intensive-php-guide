...
Как следует из названия, HTML - это язык разметки. Это означает, что с помощью HTML мы можем описать только как должна выглядеть веб-страница и что она будет содержать. Т.к. HTML - это не язык программирования, содержимое этой веб-страницы будет статичным, т.е. не содержать никакой логики, не меняться в зависимости от каких-либо условий и так далее.  
